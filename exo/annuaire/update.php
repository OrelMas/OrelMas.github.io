...
<form action="" method="post">
        <fieldset>
            ...
            <pre>
                ...
                <input type="text" name="prenom" id="prenom" maxlength="30" required value="<?php $ligne['prenom'] ?>">
                <label for="prenom">Telephone *</label>
                <input type="tel" name="tel" id="tel" minlength="10" maxlength="10" required value="<?php $ligne['telephone'] ?>">
                ...
                <label for="homme">Homme: </label> <input type="radio" name="sexe" id="homme" value="m"  required <?php echo $ligne['sexe'] == "m" ? 'checked' : ''  ?>> <label for="femme">Femme: </label><input type="radio" name="sexe" id="femme" value="f" required>
