...
<body>
    ...
    if (isset($_POST) && !empty($_POST)) {
        ...
        if (empty($select)) {
            ...
            $msg = "Lien pour réinitialiser votre mot de passe : http://localhost/cours_php/OrelMas.github.io/exo/connexion/reset.php?id=$select[0]['id']&token=$token";  
            SendEmail($select[0]['id'], $token, $_POST['email'], $msg, 'Réinitialisation du mot de passe', 'DWWM');
    }
